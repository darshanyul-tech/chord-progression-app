...
export function ScaleWritingTopic() {
  const settings = useScaleWritingSettings();
  const practice = useScaleWritingPractice(settings);
  ...
  return (
    <>
      ...
      <section className="card">
        ...
        <SessionScoreLine className="sw-session-score" correct={practice.score.correct} total={practice.score.total} />
      </section>

      <section className="card md-card-wrap">
        <div id="scale-writing-app">
